...
class Ooblet(Base):
    ...
    ooblet_name = Column(String(50), nullable=False)
    ooblet_description = Column(String(250), nullable=False)
    ooblet_location = Column(String(50), nullable=False)
    ...
    def serialize(self):
        return {
            ...
            'ooblet_description': self.ooblet_description,
...
class Character(Base):
    ...
    character_personality = Column(String(250), nullable=False)
...
class Clothing(Base):
    ...
    clothing_category= Column(String(50), nullable=False)
